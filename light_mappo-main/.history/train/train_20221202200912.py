...
# !/usr/bin/env python
import sys
sys.path.append('E:/研三/实验/light_mappo-main')
import os
import socket
import setproctitle
import numpy as np
...
# os.chdir('E:/研三/组会科研/多代理强化学习参考/MAPPO代码/light_mappo-main/')
def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            from envs.env_continuous import ContinuousActionEnv
            scenario = sc()
            env = ContinuousActionEnv(scenario)
            # from envs.env_continuous import DiscreteActionEnv
            # # from envs.env_wrappers import Env
